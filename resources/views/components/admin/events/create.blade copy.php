                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_free" value="1" class="form-checkbox">
                            <span class="ml-2">Бесплатное мероприятие</span>
                        </label>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center">
                            ...
                            <span class="ml-2">Рекомендуемое мероприятие</span>
                        </label>
                    </div>
                </div>
                <div class="mb-4">
            ...
            zones.forEach(zone => {
                ...
                for (let row = 1; row <= rowsPerZone; row++) {
                    ...
                    for (let seatNum = 1; seatNum <= seatsPerRow; seatNum++) {
                        ...
                        seat.className =
                            'seat w-8 h-8 m-1 flex items-center justify-center bg-green-200 rounded cursor-pointer';
