                ...
                <div class="flex space-x-4">
                    ...
                    <div class="relative">
                        <select name="category"
                            class="appearance-none bg-white border border-gray-300 rounded-md py-2
                            pl-3 pr-8 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500">
                    ...
                    <div class="relative">
                        <select name="date"
                            class="appearance-none bg-white border border-gray-300 rounded-md py-2 pl-3
                            pr-8 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500">
                            ...
                            <option value="weekend" {{ request('date') == 'weekend' ? 'selected' : '' }}>На выходных
                            </option>
                    ...
                    <div class="relative">
                        <select name="price"
                            class="appearance-none bg-white border border-gray-300 rounded-md py-2 pl-3 pr-8
                            text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500">
            ...
            <div class="bg-red-600 text-white rounded-lg p-6 mb-8 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center">
                    <div class="md:w-2/3 mb-4 md:mb-0 md:pr-8">
                        ...
                        <p class="mb-4">{{ $featuredEvent->start_datetime->format('d M Y, H:i') }} •
                            {{ $featuredEvent->venue->name ?? $featuredEvent->location }}</p>
                        <a href="{{ route('events.show', $featuredEvent) }}"
                            class="inline-block bg-white text-red-600 px-6 py-2 rounded-md font-medium hover:bg-gray-100 transition">Подробнее</a>
                    </div>
                    <div class="md:w-1/3">
                        <img src="{{ asset('images/' . ($featuredEvent->poster ?? '1.jpg')) }}"
                            alt="{{ $featuredEvent->title }}" class="rounded-lg shadow-md w-full h-48 object-cover">
                    </div>
                </div>
            </div>
        @endif
        ...
        <div class="mt-12">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <a href="{{ route('events.index', ['date' => 'today']) }}"
                    class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition flex items-center">
                ...
                <a href="{{ route('events.index', ['featured' => true]) }}"
                    class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition flex items-center">
