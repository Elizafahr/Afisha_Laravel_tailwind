        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mt-12">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <a href="{{ route('news.index', ['category' => 'announcements']) }}"
                    ...
                    <a href="{{ route('news.index', ['category' => 'reports']) }}"
                        class="bg-white p-6 rounded-lg shadow-sm text-center hover:bg-red-50 transition">
                        <div class="text-red-600 mb-2">
                    ...
                    <a href="{{ route('news.index', ['category' => 'interviews']) }}"
                        class="bg-white p-6 rounded-lg shadow-sm text-center hover:bg-red-50 transition">
                        <div class="text-red-600 mb-2">
                    ...
                    <a href="{{ route('news.index', ['category' => 'reviews']) }}"
                        class="bg-white p-6 rounded-lg shadow-sm text-center hover:bg-red-50 transition">
                        <div class="text-red-600 mb-2">
