            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('organizer.events.update', $event) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                @if($event->poster && strpos($event->poster, 'images/') === 0)
                                    <div class="mt-2">
                                        <img src="{{ asset($event->poster) }}" alt="Current poster" class="img-thumbnail" style="max-height: 150px;">
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="checkbox" id="remove_poster" name="remove_poster">
                                            <label class="form-check-label" for="remove_poster">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-4 pt-2">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="is_free" name="is_free" value="1"
                                        @checked(old('is_free', $event->is_free) == 1)>
                                    <label class="form-check-label" for="is_free">Бесплатное мероприятие</label>
                                </div>
                            </div>
                        </div>

                        <div class="row mb-3" id="price-field" style="{{ old('is_free', $event->is_free) ? 'display: none;' : '' }}">
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3" id="seating-options" style="{{ old('booking_type', $event->booking_type) == 'seated' ? '' : 'display: none;' }}">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-4 pt-2">
                                    <input class="form-check-input" type="checkbox" id="is_booking" name="is_booking"
                                           value="1" @checked(old('is_booking', $event->is_booking) == 1)>
