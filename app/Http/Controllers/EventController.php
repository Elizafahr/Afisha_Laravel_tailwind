...
class EventController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $freeCount = Event::where('is_free', true)->where('start_datetime', '>', now())->count();
        $featuredCount = Event::where('is_featured', true)->where('start_datetime', '>', now())->count();
   ...
   public function venueEvents($location)
{
    ...
    public function store(Event $event)
    {
        ...
        if (Favorite::where('user_id', Auth::id())->where('event_id', $event->event_id)->exists()) {
            return request()->expectsJson()
        ...
        return request()->expectsJson()
            ? response()->json(['success' => true, 'is_favorite' => true, 'message' => 'Событие добавлено в избранное'])
    ...
    public function destroy(Event $event)
    {
        ...
        if ($deleted) {
            return request()->expectsJson()
                ? response()->json(['success' => true, 'is_favorite' => false, 'message' => 'Событие удалено из избранного'])
